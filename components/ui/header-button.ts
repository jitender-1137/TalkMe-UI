...
export const HEADER_ICON_BTN =
  "h-10 w-10 shrink-0 inline-flex items-center justify-center rounded-full border border-border bg-card text-foreground hover:bg-muted-foreground/90 active:scale-95 transition-colors cursor-pointer";

export const HEADER_ICON_BTN_ACTIVE =
  "bg-primary/50 border-primary/80 text-foreground hover:bg-primary";
