...
export const ENDPOINTS = {
  ...
  MESSAGES: {
    ...
    CONSENT_STATE: (chatId: string) => `/chats/${chatId}/consent`,
    CONSENT_REQUEST: (chatId: string) => `/chats/${chatId}/consent/request`,
    CONSENT_ACCEPT: (chatId: string) => `/chats/${chatId}/consent/accept`,
    CONSENT_DECLINE: (chatId: string) => `/chats/${chatId}/consent/decline`,
    CONSENT_REVOKE: (chatId: string) => `/chats/${chatId}/consent/revoke`,
